...
import { CalendarDays, Clock, Repeat, User as UserIcon } from "lucide-react"
...
export function AddChoreModal({ open, onOpenChange, onCreateChore }: AddChoreModalProps) {
    ...
    switch (frequency) {
      ...
      case 'custom':
        if (customType === 'days_interval') {
          return new Date(now.getTime() + customValue * 24 * 60 * 60 * 1000)
        } else {
